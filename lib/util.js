...
/**
 * readFileWithIncludes() synchronously returns file as string,
...
exports.readFileWithIncludes = (path) => {
  // remove the last component (the file) of the path to get the directory path
  ...
  // recursively replace include directives
