...
/*
To make sure that the includes can be properly handled by the 
markdown-it renderer, we first translate all of the @@includes()
and then convert all the ::: components (our specific ones) into html
Then the markdown-it processes everything that is in markdown, ignoring
all of the preconverted HTML that we produce.
*/
